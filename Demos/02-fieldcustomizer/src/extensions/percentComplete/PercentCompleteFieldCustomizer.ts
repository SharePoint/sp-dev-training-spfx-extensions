...
import * as strings from 'PercentCompleteFieldCustomizerStrings';
import styles from './PercentCompleteFieldCustomizer.module.scss';
...
const LOG_SOURCE: string = 'PercentCompleteFieldCustomizer';
...
export default class PercentCompleteFieldCustomizer
  ...
  public onInit(): Promise<void> {
    ...
    Log.info(LOG_SOURCE, 'Activated PercentCompleteFieldCustomizer with properties:');
    Log.info(LOG_SOURCE, JSON.stringify(this.properties, undefined, 2));
    Log.info(LOG_SOURCE, `The following string should be equal: "PercentCompleteFieldCustomizer" and "${strings.Title}"`);
  ...
  public onRenderCell(event: IFieldCustomizerCellEventParameters): void {
    ...
    if (isNaN(fieldValue) || fieldValue === 0) {
      event.domElement.innerHTML = `
        <div class="${styles.PercentComplete}">
          <div class="">
