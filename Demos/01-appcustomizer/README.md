# DEMO: Create an application customizer extension

This completed project is the result of the lab exercise **Create an application customizer extension** that is referenced in the [README](../../README.md) in this repo.
